...
class Ui_Setting(object):
    def setupUi(self, Setting):
        ...
        self.gridLayout_3.addWidget(self.label_lang, 3, 0, 1, 1)
        ...
        self.gridLayout_3.addLayout(self.horizontalLayout_3, 7, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.label_update, 1, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.line, 14, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.line_5, 16, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.line_3, 12, 0, 1, 1)

        self.encodeSelect = QComboBox(Setting)
        self.encodeSelect.setObjectName(u"encodeSelect")

        self.gridLayout_3.addWidget(self.encodeSelect, 11, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.checkBox_IsUpdate, 1, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.line_2, 14, 2, 1, 1)
        ...
        self.gridLayout_3.addLayout(self.gridLayout_5, 15, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.line_8, 8, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.line_6, 16, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.threadSelect, 10, 2, 1, 1)

        self.checkBox = QCheckBox(Setting)
        self.checkBox.setObjectName(u"checkBox")

        self.gridLayout_3.addWidget(self.checkBox, 9, 2, 1, 1)
        ...
        self.gridLayout_3.addLayout(self.gridLayout_4, 13, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.line_4, 12, 2, 1, 1)
        ...
        self.label_20 = QLabel(Setting)
        self.label_20.setObjectName(u"label_20")

        self.horizontalLayout_6.addWidget(self.label_20)

        self.dohLine = QLineEdit(Setting)
        self.dohLine.setObjectName(u"dohLine")

        self.horizontalLayout_6.addWidget(self.dohLine)


        self.gridLayout_3.addLayout(self.horizontalLayout_6, 2, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.comboBox, 4, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.preDownNum, 6, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.langSelect, 3, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.logBox, 17, 2, 1, 1)
    ...
    def retranslateUi(self, Setting):
        ...
        self.label_9.setText(QCoreApplication.translate("Setting", u"Doh\u8bbe\u7f6e", None))
        ...
        self.dohBox.setText(QCoreApplication.translate("Setting", u"\u662f\u5426\u542f\u7528", None))
        self.label_20.setText(QCoreApplication.translate("Setting", u"\u5730\u5740", None))
        self.dohLine.setText(QCoreApplication.translate("Setting", u"https://1.1.1.1/dns-query", None))
