...
class Ui_LoginProxyWidget(object):
    def setupUi(self, LoginProxyWidget):
        ...
        self.label_e.setTextInteractionFlags(Qt.TextSelectableByMouse)

        self.gridLayout_2.addWidget(self.label_e, 2, 0, 1, 1)

        self.radio_e_4 = QRadioButton(self.scrollAreaWidgetContents)
        self.eGroup = QButtonGroup(LoginProxyWidget)
        self.eGroup.setObjectName(u"eGroup")
        self.eGroup.addButton(self.radio_e_4)
        self.radio_e_4.setObjectName(u"radio_e_4")

        self.gridLayout_2.addWidget(self.radio_e_4, 5, 1, 1, 1)

        self.label_e_4 = QLabel(self.scrollAreaWidgetContents)
        self.label_e_4.setObjectName(u"label_e_4")

        self.gridLayout_2.addWidget(self.label_e_4, 5, 2, 1, 1)

        self.radio_exa_4 = QRadioButton(self.scrollAreaWidgetContents)
        self.exaGroup = QButtonGroup(LoginProxyWidget)
        self.exaGroup.setObjectName(u"exaGroup")
        self.exaGroup.addButton(self.radio_exa_4)
        self.radio_exa_4.setObjectName(u"radio_exa_4")

        self.gridLayout_2.addWidget(self.radio_exa_4, 25, 1, 1, 1)
        ...
        self.radio_api_4 = QRadioButton(self.scrollAreaWidgetContents)
        self.apiGroup = QButtonGroup(LoginProxyWidget)
        self.apiGroup.setObjectName(u"apiGroup")
        self.apiGroup.addButton(self.radio_api_4)
        self.radio_api_4.setObjectName(u"radio_api_4")

        self.gridLayout_2.addWidget(self.radio_api_4, 10, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.radio_api_2, 8, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.radio_exa_3, 24, 1, 1, 1)

        self.label_api = QLabel(self.scrollAreaWidgetContents)
        self.label_api.setObjectName(u"label_api")
        self.label_api.setTextInteractionFlags(Qt.TextSelectableByMouse)

        self.gridLayout_2.addWidget(self.label_api, 7, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_eh_1, 17, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.radio_ex_2, 13, 1, 1, 1)

        self.label_ex_3 = QLabel(self.scrollAreaWidgetContents)
        self.label_ex_3.setObjectName(u"label_ex_3")

        self.gridLayout_2.addWidget(self.label_ex_3, 14, 2, 1, 1)

        self.radio_eh_4 = QRadioButton(self.scrollAreaWidgetContents)
        self.ehGroup = QButtonGroup(LoginProxyWidget)
        self.ehGroup.setObjectName(u"ehGroup")
        self.ehGroup.addButton(self.radio_eh_4)
        self.radio_eh_4.setObjectName(u"radio_eh_4")

        self.gridLayout_2.addWidget(self.radio_eh_4, 20, 1, 1, 1)

        self.label_ex_4 = QLabel(self.scrollAreaWidgetContents)
        self.label_ex_4.setObjectName(u"label_ex_4")

        self.gridLayout_2.addWidget(self.label_ex_4, 15, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.radio_api_1, 7, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.radio_exa_2, 23, 1, 1, 1)
        ...
        self.label_eh_4 = QLabel(self.scrollAreaWidgetContents)
        self.label_eh_4.setObjectName(u"label_eh_4")

        self.gridLayout_2.addWidget(self.label_eh_4, 20, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_api_4, 10, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.radio_eh_1, 17, 1, 1, 1)

        self.label_exa_1 = QLabel(self.scrollAreaWidgetContents)
        self.label_exa_1.setObjectName(u"label_exa_1")

        self.gridLayout_2.addWidget(self.label_exa_1, 22, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.radio_ex_1, 12, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.radio_exa_1, 22, 1, 1, 1)
        ...
        self.radio_ex_4 = QRadioButton(self.scrollAreaWidgetContents)
        self.exGroup.addButton(self.radio_ex_4)
        self.radio_ex_4.setObjectName(u"radio_ex_4")

        self.gridLayout_2.addWidget(self.radio_ex_4, 15, 1, 1, 1)

        self.label_ex_1 = QLabel(self.scrollAreaWidgetContents)
        self.label_ex_1.setObjectName(u"label_ex_1")

        self.gridLayout_2.addWidget(self.label_ex_1, 12, 2, 1, 1)

        self.label_exa_3 = QLabel(self.scrollAreaWidgetContents)
        self.label_exa_3.setObjectName(u"label_exa_3")

        self.gridLayout_2.addWidget(self.label_exa_3, 24, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.radio_eh_2, 18, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.line_5, 21, 0, 1, 1)
        ...
        self.label_exa_4 = QLabel(self.scrollAreaWidgetContents)
        self.label_exa_4.setObjectName(u"label_exa_4")

        self.gridLayout_2.addWidget(self.label_exa_4, 25, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.radio_api_3, 9, 1, 1, 1)

        self.label_exa_2 = QLabel(self.scrollAreaWidgetContents)
        self.label_exa_2.setObjectName(u"label_exa_2")

        self.gridLayout_2.addWidget(self.label_exa_2, 23, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.line_6, 16, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.radio_eh_3, 19, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.radio_ex_3, 14, 1, 1, 1)

        self.label_ex_2 = QLabel(self.scrollAreaWidgetContents)
        self.label_ex_2.setObjectName(u"label_ex_2")

        self.gridLayout_2.addWidget(self.label_ex_2, 13, 2, 1, 1)
    ...
    def retranslateUi(self, LoginProxyWidget):
        ...
        self.radio_e_4.setText(QCoreApplication.translate("LoginProxyWidget", u"\u81ea\u5b9a\u4e49IP", None))
        self.label_e_4.setText("")
        self.radio_exa_4.setText(QCoreApplication.translate("LoginProxyWidget", u"\u81ea\u5b9a\u4e49IP", None))
        self.label_eh.setText(QCoreApplication.translate("LoginProxyWidget", u"ehgt.org", None))
        self.radio_api_4.setText(QCoreApplication.translate("LoginProxyWidget", u"\u81ea\u5b9a\u4e49IP", None))
        ...
        self.radio_eh_4.setText(QCoreApplication.translate("LoginProxyWidget", u"\u81ea\u5b9a\u4e49IP", None))
        self.label_ex_4.setText("")
        ...
        self.radio_ex_4.setText(QCoreApplication.translate("LoginProxyWidget", u"\u81ea\u5b9a\u4e49IP", None))
