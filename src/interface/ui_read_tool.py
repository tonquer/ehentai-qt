...
class Ui_ReadImg(object):
    def setupUi(self, ReadImg):
        ...
        self.gridLayout.addWidget(self.preDownWaifu2x, 1, 1, 1, 1)
        ...
        self.horizontalLayout_9.addWidget(self.curWaifu2x)
        ...
        self.gridLayout.addWidget(self.waifu2xCancle, 2, 1, 1, 1)
