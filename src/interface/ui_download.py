...
class Ui_Download(object):
    ...
    def retranslateUi(self, Download):
        ...
        ___qtablewidgetitem3.setText(QCoreApplication.translate("Download", u"\u7ad9\u70b9", None));
        ...
        ___qtablewidgetitem7.setText(QCoreApplication.translate("Download", u"\u4e0b\u8f7d\u72b6\u6001", None));
        ___qtablewidgetitem8 = self.tableWidget.horizontalHeaderItem(8)
        ___qtablewidgetitem8.setText(QCoreApplication.translate("Download", u"\u8f6c\u6362\u8fdb\u5ea6", None));
